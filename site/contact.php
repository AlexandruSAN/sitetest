    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-primary px-3">Formular de contact</h6>
                <h1 class="mb-5">Pentru orice problema/nelamuriri ne puteti contacta</h1>
            </div>
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <h5>Ia legatura cu noi</h5>
                    <p class="mb-4">Aceasta este adresa noastra de email pentru contact.</p>
                ...
                <div class="col-lg-4 col-md-12 wow fadeInUp" data-wow-delay="0.5s">
                    <form id="contact-form" action="https://api.web3forms.com/submit" method="POST">
					 <input type="hidden" name="access_key" value="ef09e222-1df9-4885-a02c-1854b458570e">
                        <div class="row g-3">
                            <div class="col-md-6">
